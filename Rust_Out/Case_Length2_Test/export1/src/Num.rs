...
pub fn times_num 
  (m: Num, n: Num) -> Num
     {
    match (m, n) {
      (Num::Bit1 (box m), Num::Bit1 (box n)) => Num::Bit1 (Box::new(plus_num(plus_num(m.clone(), n.clone()), Num::Bit0 (Box::new(times_num(m.clone(), n.clone())))))), 
      (Num::Bit1 (box m), Num::Bit0 (box n)) => Num::Bit0 (Box::new(times_num(Num::Bit1 (Box::new(m.clone())), n.clone()))), 
      (Num::Bit0 (box m), Num::Bit1 (box n)) => Num::Bit0 (Box::new(times_num(m.clone(), Num::Bit1 (Box::new(n.clone()))))), 
      (Num::Bit0 (box m), Num::Bit0 (box n)) => Num::Bit0 (Box::new(Num::Bit0 (Box::new(times_num(m.clone(), n.clone()))))), 
      (Num::One, n) => n.clone(), 
      (m, Num::One) => m.clone()
    }
  }
